...
Feedforward neural nets do not possess memory. These networks make decisions, starting from zero every time. When processing speech its is important however to take context into account. That is why recurrent loops are introduced into the net, which give it access to it's past outputs \cite{Colah2015}.
\begin{figure}
...
\label{fig:lstm}
\end{figure}
This system of equation is visualized in figure~\ref{fig:lstm}. 
